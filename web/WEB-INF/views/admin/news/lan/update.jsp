...
<div id="wrapper">
    ...
    <div id="page-wrapper" >
        ...
        <div class="row">
            <div class="col-lg-12">
                <form id="formid" action="/admin/news/lan/update/${dataitem.id}/${news_id}" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="form-group">
                                <label>标题</label>
                                <input class="form-control " name="newsname" value="${dataitem.newsname}" required>
                            </div>
                            <div class="form-group">
                                <label>描述</label>
