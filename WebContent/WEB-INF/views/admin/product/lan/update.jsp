...
<div id="wrapper">
    ...
    <div id="page-wrapper" >
        ...
        <div class="row">
            <div class="col-lg-12">
                <form id="formid" action="admin/product/lan/update/${dataitem.id}/${product_id}" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>标题</label>
                                <input class="form-control" name="productname" value="${dataitem.productname}" required>
                            </div>
                            <div class="form-group">
                                <label>描述</label>
